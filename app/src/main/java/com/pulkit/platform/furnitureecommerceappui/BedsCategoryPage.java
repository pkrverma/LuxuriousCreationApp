...
public class BedsCategoryPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favoriteButton.setOnClickListener(v -> {
            Intent intent = new Intent(BedsCategoryPage.this, FavouritePage.class);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in, 0);  // No exit transition for BedsCategoryPage
        });
    ...
    private BedsModel[] bedModels = {
            new BedsModel(R.string.model9_name, 14490.00, R.drawable.model9, R.string.model9_desc, "", R.string.model9_arLink),
            new BedsModel(R.string.model2_name, 13540.00, R.drawable.model2, R.string.model2_desc, "", R.string.model2_arLink),
            new BedsModel(R.string.model3_name, 13540.00, R.drawable.model3, R.string.model3_desc, "", R.string.model3_arLink),
            new BedsModel(R.string.model4_name, 11200.00, R.drawable.model4, R.string.model4_desc, "", R.string.model4_arLink),
            new BedsModel(R.string.model5_name, 9569.00, R.drawable.model5, R.string.model5_desc, "", R.string.model5_arLink),
            new BedsModel(R.string.model6_name, 15450.00, R.drawable.model6, R.string.model6_desc, "", R.string.model6_arLink)
    };
    ...
    private void addCardView(BedsModel model, GridLayout gridLayout) {
        ...
        heartIcon.setOnClickListener(v -> {
            if (isFavorite[0]) {
                ...
                Toast.makeText(BedsCategoryPage.this, "Removed from favorites", Toast.LENGTH_SHORT).show();
            } else {
                ...
                Toast.makeText(BedsCategoryPage.this, "Added to favorites", Toast.LENGTH_SHORT).show();
            }
    ...
    public static class BedsModel {
        ...
        public BedsModel(int name, double price, int imageResource, int description, String shopUrl, int arUrl) {
            this.name = name;
            this.price = price;
