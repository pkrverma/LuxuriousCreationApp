...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize the FloatingActionButton for favorites
        FloatingActionButton favoriteButton = findViewById(R.id.favorite);

        // Initialize the LinearLayout for home button
        ...
        homeLinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                finish(); // Optional: Call finish() if you want to remove Main3Activity from the back stack
            }
        });
    }
}
